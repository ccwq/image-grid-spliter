...
const destroyLightbox = () => { if (previewToastTimer) clearTimeout(previewToastTimer); previewToastElement = null; lightboxRef.value?.destroy(); lightboxRef.value = null; lightboxInitialized.value = false; previewActive.value = false }
